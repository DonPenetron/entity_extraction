...
ENTITY_TYPE = "strategic_direction"
...
re_rules_free = [
    {
        "pattern": r"Стратегическое[ ]{1,5}направление[ ]{1,5}\d{1,2}[:]",
        "action": "match",
...
gparser_rules_anchor = [
    Rule(
        Text("осуществляется", lemma=True),
        Text("через", lemma=True),
        Text("реализацию", lemma=True),
        Text("стратегических", lemma=True),
        Text("направлений", lemma=True),
    )
]
